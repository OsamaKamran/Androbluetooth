...
public class arrowkeys extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_arrowkeys);

        up=(ImageButton)findViewById(R.id.imageButton3);
        down=(ImageButton)findViewById(R.id.imageButton6);
        left=(ImageButton)findViewById(R.id.imageButton8);
        right=(ImageButton)findViewById(R.id.imageButton7);
